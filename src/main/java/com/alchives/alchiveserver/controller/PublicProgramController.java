...
public class PublicProgramController {
  ...
  @PostMapping("/create")
  public ResponseEntity<Object> createInstitute(@ModelAttribute ProgramDTO request) {
    return programService.createProgram(request);
  }

  @PatchMapping(value = "/{id}")
  public ResponseEntity<Object> updateAlumni(@PathVariable("id") Integer id, @ModelAttribute ProgramDTO request) {
